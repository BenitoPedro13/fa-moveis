...
export const produtos: Produto[] = [
  ...
  },
  {
    ...
    nome: "Cômoda Space Plus 5 Gavetas 2 Portas",
    categoria: "comodas",
    ambientes: ["quarto"],
    ...
    imagens: [
      {
        ...
        alt: "Cômoda Space Plus 5 Gavetas 2 Portas, acabamento cumaru",
        tipo: "produto",
      },
    ],
    preco: { aVista: 1082.76 },
    fabricante: "Novo Horizonte",
    disponivel: true,
  },
  {
  ...
  },
  {
    ...
    nome: "Cabeceira Casal Everest Plus",
    categoria: "cabeceiras",
    ambientes: ["quarto"],
    ...
    imagens: [
      {
        ...
        alt: "Cabeceira Casal Everest Plus, acabamento cumaru",
        tipo: "produto",
      },
    ],
    preco: { aVista: 1004.52 },
    fabricante: "Novo Horizonte",
    disponivel: true,
  },
  {
  ...
  },
  {
    ...
    preco: { aVista: 1665.12 },
    fabricante: "Novo Horizonte",
    disponivel: true,
  },
  {
    slug: "roupeiro-paradizzo",
    nome: "Roupeiro Paradizzo Gold",
    categoria: "roupeiros",
    ambientes: ["quarto"],
    resumo: "Roupeiro de casal com 3 portas de correr, espelho central e bastante espaço interno.",
    descricao:
      "Roupeiro de casal com 3 portas de correr, espelho central e 6 gavetas. Altura com pés: " +
      "2,18 m. Móvel de fábrica, entregue e montado na sua casa pela F&A Móveis.",
    ...
    imagens: [
      {
        ...
        alt: "Roupeiro Paradizzo Gold, acabamento cumaru",
        tipo: "produto",
      },
    ],
    preco: { aVista: 3163.42 },
    fabricante: "Novo Horizonte",
    disponivel: true,
  },
  {
